            ...
            <ul>
                <li className="menu-item-has-children">
                    ...
                    {/* <ul className="sub-menu">
                        <li><Link href={route('home')}>Home 01</Link></li>
                ...
                <li className="menu-item-has-children"><Link className='nav-link' href={route("project")}>Projects </Link>
                    {/* <ul className="sub-menu">
                ...
                <li><Link href={route("contact")} className='nav-link'>Contact</Link></li>
            </ul>
        </>
    );
};
