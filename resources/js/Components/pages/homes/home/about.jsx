...
const About = () => {
    const brand1 = window.imageUrl+"img/brand/brand-1.png";
    const brand2 = window.imageUrl+"img/brand/brand-2.png";
    const brand3 = window.imageUrl+"img/brand/brand-3.png";
    const brand4 = window.imageUrl+"img/brand/brand-4.png";
    const brand5 = window.imageUrl+"img/brand/brand-5.png";
    const about1 = window.imageUrl+"img/about/about-1.png";
    const about2 = window.imageUrl+"img/about/about-2.png";
    return (
        <>
